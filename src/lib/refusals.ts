...
export const REFUSALS = {
  ...
  PAYMENT_PROTOCOL_TAKEN: "registry/payment-protocols.json lists this id twice",
  PAYMENT_PROTOCOL_UNKNOWN: "a payments block or probe names a protocol that is not in registry/payment-protocols.json",
  PAYMENT_PROTOCOL_MISSING: "a machine-payable tool names at least one payment protocol",
